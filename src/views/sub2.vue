      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <WordCloud :answers="answers" :questions="questions2" />
          </div>
        </div>
      </div>
    </div>
...
import { questions2 } from '../types/questionnaire';
...
export default defineComponent({
  ...
  setup() {
    ...
    const submitForm = () => {
      ...
      // 检查所有问题是否已回答
      const unansweredQuestions = questions2.filter(q => !answers[q.id]);
      ...
      dataManager.saveData('sub1', answers);
