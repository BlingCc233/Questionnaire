      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <WordCloud :answers="answers" :questions="questions3" />
          </div>
        </div>
      </div>
    </div>
...
import {type Question, questions3} from '../types/questionnaire';
...
export default defineComponent({
  ...
  setup() {
    ...
    const submitForm = () => {
      ...
      // 检查所有问题是否已回答
      const unansweredQuestions = questions3.filter(q => !isQuestionAnswered(q));
      ...
      dataManager.saveData('sub2', answers);
